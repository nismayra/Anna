...
# Display only available columns without KeyError
display_columns = [col for col in ['College', 'Branch Name - Selected 98', 'OC', 'BC', 'MBCV'] if col in filtered_df.columns]
